...
function _t(e, t, r, n, a) {
  ...
  return Array.isArray(t)
    ? (t.forEach(function (t) {
        ...
        n &&
          (i =
            Mt(r, a) && e === ie.default(r, t, { awareOfUnicodeTokens: !0 })),
          Mt(r, a) && i && (o = r);
      }),
      o)
...
function Et(e, t) {
  var r = t.dateFormat,
    n = t.locale;
  return (e && Pt(e, Array.isArray(r) ? r[0] : r, n)) || "";
}
function Nt(e, t) {
  var r = t.hour,
    n = void 0 === r ? 0 : r,
...
function Qt(e, t) {
  return Pt(xe.default(St(), e), "LLLL", t);
}
function Vt(e, t) {
  return Pt(xe.default(St(), e), "LLL", t);
}
function Ut(e, t) {
...
function Zt(e) {
  var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
    ...
    n = t.maxDate,
    a = new Date(e, 0, 1);
  return tr(a, { minDate: r, maxDate: n }) || !1;
}
function er(e, t, r, n) {
  var a = Me.default(e),
    o = _e.default(e),
...
function nr(e) {
  var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
    ...
    n = t.includeTimes,
    a = t.filterTime;
  return (r && rr(e, r)) || (n && !rr(e, n)) || (a && !a(e)) || !1;
}
function ar(e, t) {
  var r = t.minTime,
    n = t.maxTime;
...
var yr = (function (e) {
    ...
    function r(e) {
      ...
      return (
        (n.state = {
          yearsList: mr(n.props.year, s, n.props.minDate, n.props.maxDate),
        }),
        n
      );
    }
...
function br(e, t) {
  for (var r = [], n = It(e), a = It(t); !Ge.default(n, a); )
    r.push(St(n)), (n = ue.default(n, 1));
  return r;
}
var Cr = (function (e) {
    ut(r, ne["default"].Component);
      ...
      return (
        ...
        ct(mt((n = t.call(this, e))), "renderOptions", function () {
          return n.state.monthYearsList.map(function (e) {
            var t = Pe.default(e),
              r = Rt(n.props.date, e) && qt(n.props.date, e);
            return ne.default.createElement(
              "div",
              {
                className: r
        ...
        (n.state = { monthYearsList: br(n.props.minDate, n.props.maxDate) }),
        n
      );
    }
    return (
  ...
  _r = (function (e) {
    ...
    function r() {
      ...
      return (
        ...
        ct(mt(e), "renderSelectOptions", function () {
          for (
            var t = It(e.props.minDate), r = It(e.props.maxDate), n = [];
            !Ge.default(t, r);
        ...
        ct(mt(e), "onChange", function (t) {
          e.toggleDropdown();
          var r = St(parseInt(t));
          (Rt(e.props.date, r) && qt(e.props.date, r)) || e.props.onChange(r);
        }),
        ct(mt(e), "toggleDropdown", function () {
          return e.setState({ dropdownVisible: !e.state.dropdownVisible });
        }),
      ...
      return (
        ...
        ct(mt(e), "isInSelectingRange", function () {
          ...
          return (
            ...
            (a && p && (Je.default(l, p) || Wt(l, p))
              ? Bt(n, l, p)
              : ((o && i && (Ge.default(l, i) || Wt(l, i))) ||
                  !(!s || !i || p || (!Ge.default(l, i) && !Wt(l, i)))) &&
                Bt(n, i, l))
          );
        }),
        ...
        ct(mt(e), "getClassNames", function (t) {
          ...
          return ae.default(
            ...
            r,
            "react-datepicker__day--" + xt(e.props.day),
            {
        ...
        ct(mt(e), "getTabIndex", function (t, r) {
          ...
          return e.isKeyboardSelected() || (e.isSameDay(n) && Kt(a, n))
            ? 0
            : -1;
        }),
      ...
      return (
        ...
        ct(mt(e), "isRangeStartMonth", function (t) {
          var r = e.props,
            ...
            a = r.startDate,
            o = r.endDate;
          return !(!a || !o) && qt(xe.default(n, t), a);
        }),
        ct(mt(e), "isRangeStartQuarter", function (t) {
          var r = e.props,
            ...
            a = r.startDate,
            o = r.endDate;
          return !(!a || !o) && At(Ye.default(n, t), a);
        }),
        ct(mt(e), "isRangeEndMonth", function (t) {
          var r = e.props,
            ...
            a = r.startDate,
            o = r.endDate;
          return !(!a || !o) && qt(xe.default(n, t), o);
        }),
        ct(mt(e), "isRangeEndQuarter", function (t) {
          var r = e.props,
            ...
            a = r.startDate,
            o = r.endDate;
          return !(!a || !o) && At(Ye.default(n, t), o);
        }),
        ...
        ct(mt(e), "renderWeeks", function () {
          for (
            var t = [],
              ...
              n = 0,
              a = !1,
              o = Tt(It(e.props.day), e.props.locale, e.props.calendarStartDay);
            t.push(
        ...
        ct(mt(e), "onMonthClick", function (t, r) {
          e.handleDayClick(It(xe.default(e.props.day, r)), t);
        }),
          ...
          return ae.default(
            ...
            d,
            {
              "react-datepicker__month--disabled":
                (i || p) && Gt(xe.default(n, t), e.props),
              "react-datepicker__month--selected":
                Se.default(n) === t && Me.default(n) === Me.default(s),
              "react-datepicker__month-text--keyboard-selected":
                Se.default(l) === t,
              "react-datepicker__month--in-range": Jt(a, o, t, n),
          ...
          return ae.default(
            ...
            "react-datepicker__quarter-".concat(t),
            {
              "react-datepicker__quarter--disabled":
                (i || p) && Xt(Ye.default(n, t), e.props),
              "react-datepicker__quarter--selected":
                _e.default(n) === t && Me.default(n) === Me.default(s),
              "react-datepicker__quarter--in-range": er(a, o, t, n),
  ...
  Or = (function (e) {
    ...
    function r() {
      ...
      return (
        ...
        ct(mt(e), "handleClick", function (t) {
          ((e.props.minTime || e.props.maxTime) && ar(t, e.props)) ||
...
ct(Or, "calcCenterPosition", function (e, t) {
    ...
    function r(e) {
      ...
      return (
        ...
        ct(
          mt((n = t.call(this, e))),
          "YEAR_REFS",
          Dt(Array(n.props.yearItemNumber)).map(function () {
            return ne.default.createRef();
          })
        ),
        ...
        ct(mt(n), "isKeyboardSelected", function (e) {
          var t = Lt(Te.default(n.props.date, e));
          return (
            !n.props.disabledKeyboardNavigation &&
            !n.props.inline &&
            !Kt(t, Lt(n.props.selected)) &&
            Kt(t, Lt(n.props.preSelection))
          );
        }),
        ct(mt(n), "onYearClick", function (e, t) {
          var r = n.props.date;
          n.handleYearClick(Lt(Te.default(r, t)), e);
        }),
        ...
        ct(mt(n), "getYearClassNames", function (e) {
          ...
          return ae.default("react-datepicker__year-text", {
            ...
            "react-datepicker__year-text--disabled": (r || a) && Zt(e, n.props),
      ...
      return (
        ...
        ct(mt(n), "header", function () {
          var e =
              arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : n.state.date,
            t = Tt(e, n.props.locale, n.props.calendarStartDay),
            r = [];
          return (
              ...
              case n.props.showYearPicker:
                e = (function (e) {
                  var t =
                    ...
                    n = t.yearItemNumber,
                    a = void 0 === n ? 12 : n,
                    o = hr(Lt(ve.default(e, a)), a).endPeriod,
                    s = r && Me.default(r);
                  return (s && s > o) || !1;
              ...
              case n.props.showYearPicker:
                e = (function (e) {
                  var t =
                    ...
                    n = t.yearItemNumber,
                    a = void 0 === n ? 12 : n,
                    o = hr(fe.default(e, a), a).startPeriod,
                    s = r && Me.default(r);
                  return (s && s < o) || !1;
                })(n.state.date, n.props);
                break;
        ...
        ct(mt(n), "renderYearDropdown", function () {
          ...
          if (n.props.showYearDropdown && !e)
            return ne.default.createElement(Dr, {
          ...
          if (n.props.todayButton && !n.props.showTimeSelectOnly)
            return ne.default.createElement(
              "div",
              {
                ...
                onClick: function (e) {
                  return n.props.onSelect(Ae.default(St()), e);
                },
              },
              n.props.todayButton
            );
        ...
        ct(mt(n), "renderCustomHeader", function () {
          ...
          if (
            ...
            return null;
          var a = or(n.state.date, n.props),
            o = sr(n.state.date, n.props),
            s = ir(n.state.date, n.props),
            i = pr(n.state.date, n.props),
            p =
              !n.props.showMonthYearPicker &&
              !n.props.showQuarterYearPicker &&
              !n.props.showYearPicker;
        ...
        ct(mt(n), "renderTimeSection", function () {
          if (
            ...
            return ne.default.createElement(Or, {
              selected: n.props.selected,
        ...
        [
          {
            ...
            value: function () {
              ...
              this.props.popperContainer &&
                ...
                u &&
                  !a &&
                  (e = ne.default.createElement(Fr, { portalId: u }, e));
    ...
    function r(e) {
      ...
      return (
        ...
        ct(mt(n), "setPreSelection", function (e) {
          ...
          if (e) {
            var o = Ae.default(e);
            if (t && r) a = Bt(e, n.props.minDate, n.props.maxDate);
            else if (t) {
              var s = Ae.default(n.props.minDate);
              a = Ge.default(e, s) || Wt(o, s);
            } else if (r) {
              var i = He.default(n.props.maxDate);
              a = Je.default(e, i) || Wt(o, i);
            }
          }
        ...
        ct(mt(n), "handleTimeChange", function (e) {
          ...
          n.setState({ preSelection: t }),
            ...
            n.props.inline || n.setState({ inputValue: null });
        }),
        ...
        [
          ...
          },
          {
            ...
            value: function () {
              ...
              return ne.default.createElement(Ar, {
