!(function (e, t) {
  ...
  function (
    ...
    var Sr = (function (e) {
        ...
        function r(e) {
          ...
          ht(this, r),
            ...
            Dt(bt(a), "shiftYears", function (e) {
              var t = a.state.yearsList.map(function (t) {
                return t + e;
              });
              a.setState({ yearsList: t });
            }),
            Dt(bt(a), "incrementYears", function () {
              return a.shiftYears(1);
            }),
            Dt(bt(a), "decrementYears", function () {
              return a.shiftYears(-1);
            });
      ...
      Mr = (function (e) {
        ...
        function r() {
          ...
          for (var a = arguments.length, n = new Array(a), o = 0; o < a; o++)
            n[o] = arguments[o];
          return (
            Dt(bt((e = t.call.apply(t, [this].concat(n)))), "state", {
              dropdownVisible: !1,
            }),
      ...
      Ir = (function (e) {
        ...
        function r() {
          ...
          return (
            ...
            Dt(bt(e), "isOutsideMonth", function () {
              return (
    ...
    Dt(qr, "calcCenterPosition", function (e, t) {
        ...
        function r(e) {
          ...
          return (
            ...
            Dt(
              bt((a = t.call(this, e))),
              "YEAR_REFS",
              _t(Array(a.props.yearItemNumber)).map(function () {
                return de.default.createRef();
              })
            ),
            ...
            Dt(bt(a), "header", function () {
              var e =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ? arguments[0]
                    : a.state.date,
                t = Kt(e, a.props.locale, a.props.calendarStartDay),
                r = [];
              return (
          ...
          return (
            ...
            Dt(bt(a), "handleTimeChange", function (e) {
              ...
              a.setState({ preSelection: t }),
                ...
                a.props.inline || a.setState({ inputValue: null });
            }),
            ...
            Dt(bt(a), "renderDateInput", function () {
              ...
              return de.default.cloneElement(
                ...
                Dt(e, "className", ce.default(r.props.className, t)),
